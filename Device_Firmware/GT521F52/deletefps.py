...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.user_label.setGeometry(100, 250, 280, 60)
        self.user_label.setAlignment(Qt.AlignCenter)
        self.user_label.setFont(QFont("Arial", 14))

        dlt_button = QPushButton("Delete", self)
        dlt_button.clicked.connect(self.deleteusers)
        dlt_button.setGeometry(100, 350, 280, 60)

        self.user_label1 = QLabel("Delete ID:", self)
        self.user_label1.setGeometry(100, 400, 280, 60)
    ...
    def deleteusers(self):
        ...
        if f.delete(id_to_delete):
            ...
            self.user_label1.setText("deleted ID: %d" % idtemp)
        else:
