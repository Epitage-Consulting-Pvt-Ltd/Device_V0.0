...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(1, 1, 480, 800)  # Adjust the window size as needed
        ...
        self.fn_edit = QLineEdit(self)

        self.ln_label = QLabel("Last Name:", self)
        self.ln_edit = QLineEdit(self)

        self.eid_label = QLabel("Employee ID:", self)
        self.eid_edit = QLineEdit(self)

        self.enroll_button = QPushButton("Enroll", self)
        self.enroll_button.clicked.connect(self.enrollid)

        layout.addWidget(self.fn_label)
        layout.addWidget(self.fn_edit)
        layout.addWidget(self.ln_label)
        layout.addWidget(self.ln_edit)
        layout.addWidget(self.eid_label)
        layout.addWidget(self.eid_edit)
    ...
    def enrollid(self):
        ...
        if f.capture_finger():
            ...
            # Store user details in a CSV file
            ...
            print("Fingerprint enrolled and user details stored.")
        else:
            print("Failed to capture fingerprint.")
        #deleted nexrt function copy pasted in python ide
