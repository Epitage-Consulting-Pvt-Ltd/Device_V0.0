...
class TopBandLayout(QWidget):
    def __init__(self, windowtitle, parent=None):
        ...
        bottom_left_label = QLabel(self)
        bottom_left_label.setText("+91XXXXXX")
        layout.addWidget(bottom_left_label, 1, 0, alignment=Qt.AlignBottom | Qt.AlignLeft)

        bottom_right_label = QLabel(self)
        bottom_right_label.setText("Epitage Consulting Pvt Ltd")
        layout.addWidget(bottom_right_label, 1, 2, alignment=Qt.AlignBottom | Qt.AlignRight)

        # Add a row stretch to ensure the bottom two items are visible
